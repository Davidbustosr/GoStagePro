...
const PricingCard = ({ plan }) => {
  const { name, price, business, features, isSpecial, link } = plan;
  return (
    <div
      ...
      <div className="common__gradient__bg pricing__gradient single__transform">
        ...
        >
            ...
            <ul>
              {features?.map((feature, idx) => (
                <li key={idx}>
                  ...
                  >
                    <path d="M16 2L6 14L0 8l1.5-1.5L6 11l8.5-10z" />
                  </svg>
          ...
          <div className="pricing__single__button">
            <Link className="default__button common__gradient__bg" href={link}>
