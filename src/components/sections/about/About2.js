            ...
            <div className="about__inner about__inner--2">
              <div className="section__title section__title--2  sp_bottom_30">
                <div className="section__title__button">
                  <span className="text__gradient">Nuestra Misión</span>
                </div>
                <div className="section__title__heading">
                  <h3>
                  TRANSFORMAR LA ADORACION A TRAVES DE LA MUSICA.
                  </h3>
                </div>
              </div>
              ...
              <div className="about__vision__wrapper">
                ...
                <div className="about__text__wrapper">
                  ...
                  <div className="about__text__2">
                    <p>
                    Empoderar a músicos y líderes de adoración con herramientas{" "}
                      <Link href="#">accesibles y profesionales</Link> que transformen la experiencia musical en escenarios cristianos.
                    </p>
                  </div>
                  <div className="about__button">
                    <ButtonPrimary
                      text="DESCUBRE MAS SOBRE NOSOTROS"
                      path="/about"
                      button="black"
                    />
                  </div>
